...
namespace FireCodingDesign.Controllers
{
    public class CompaniesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CompanyId,CompanyName,Description,PhoneNumber,Email,Adress,OrganizationNumber")] Company company)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CompanyId,CompanyName,Description,PhoneNumber,Email,Adress,OrganizationNumber")] Company company)
        {
